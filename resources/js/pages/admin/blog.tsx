...
export default function Blog() {
    return (
        <>
            <Head title="Blog Management - Rumah UKAI" />
            <AdminLayout activeMenu="blog">
                <div className="px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
                    {/* Header */}
                    <div className="flex justify-between items-center mb-8">
                        <div>
                            <h2 className="text-3xl font-bold text-white">Blog</h2>
                            <p className="text-gray-400 mt-1">Kelola semua artikel blog</p>
                        </div>
                        ...
                        <table className="w-full">
                            <thead>
                                <tr className="border-b border-gray-700 bg-gray-900">
                                    ...
                                    <th className="px-6 py-4 text-left text-sm font-semibold text-white">Penulis</th>
                            ...
                            <tbody>
                                {[1, 2, 3, 4, 5].map((item) => (
                                    <tr key={item} className="border-b border-gray-700 hover:bg-gray-700 transition">
                                        <td className="px-6 py-4 text-sm text-white">Artikel Blog {item}</td>
                                        <td className="px-6 py-4 text-sm text-gray-400">Admin</td>
